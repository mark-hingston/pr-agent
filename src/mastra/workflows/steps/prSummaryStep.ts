import { CoreMessage, Step, StepExecutionContext } from "@mastra/core"; // Added StepExecutionContext
...
\`\`\``;
        ...
        console.log("User message content for summary agent:", userMessageContent); // Added log
